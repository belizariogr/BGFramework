(function($) {
    ...
    DateTimePicker.prototype = {
        ...
        pickingDate: function(){
            return $(this.widget.find(".datepicker")[0]).is(":visible");
        },
        pickingTime: function(){
            return $(this.widget.find(".timepicker")[0]).is(":visible");
        },
        show: function(e) {
            this.widget.show();
        ...
        place: function() {
            ...
            var input = this.$element.find('input');
            var offset = input ? input.offset() : (this.component ? this.component.offset() : this.$element.offset());
        ...
        formatDate: function(date) {
            return  formatDate(convertLocalDateToUTCDate(date), this.format);
        },
