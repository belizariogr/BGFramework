(function($) {
    ...
    DateTimePicker.prototype = {
        ...
        getBtn: function(e) {
            ...
            if ($(e.target).is('.btn'))
                return e.target;
            if ($(e.target).parent().is('.btn'))
                return $(e.target).parent().get(0);
        },
        show: function(e) {
            if (this.isShowing) {
		...
		setViewDate: function(d) {
			let tmp = new Date();
            this.viewDate = d || getUTCDate(tmp.getUTCFullYear(), tmp.getUTCMonth() + 1, 1, 0, 0, 0, 0);
		},
        ...
        setDate: function(date) {
            if (date === undefined || date === null) this.setValue(null);
            else this.setValue(new Date(date))
        },
        ...
        getLocalDate: function() {
			if (this._unset) return null;
			return convertLocalDateToUTCDate(this._date);
        },
        ...
        update: function(newDate) {
            ...
            if (!dateStr) {
                ...
                if (!this._date) {
                    let tmp = new Date;
					this._date = getLocalDate(tmp.getFullYear(), tmp.getMonth(), tmp.getDate(), tmp.getHours(), tmp.getMinutes(), tmp.getSeconds(), tmp.getMilliseconds())
                }
			}
            this.setViewDate(this._date);
            this.fillDate();
        ...
        fillDate: function() {
            ...
            if (!this._date){
                var d = new Date();
                var currentDate = getUTCDate(d.getUTCFullYear(), d.getUTCMonth() + 1, d.getUTCDate(), 0, 0, 0, 0);
            } else {
                if (!(this._date instanceof Date))
                    this._date = new Date(this._date);
                var currentDate = getUTCDate(this._date.getUTCFullYear(), this._date.getUTCMonth() + 1, this._date.getUTCDate(), 0, 0, 0, 0);
            }
            ...
            var prevMonth = getUTCDate(year, month, 28, 0, 0, 0, 0);
                ...
                if (!target.is(".disabled")) {
                    switch (target[0].nodeName.toLowerCase()) {
                        ...
                        case "span":
                            ...
                            if (this.viewMode !== 0) {
								this._date = getUTCDate(this.viewDate.getUTCFullYear(), this.viewDate.getUTCMonth() + 1, this.viewDate.getUTCDate(), this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds());
                                this.notifyChange()
                            }
                            this.showMode(-1);
                            this.fillDate();
                        ...
                        case "td":
                            if (target.is(".day")) {
                                ...
                                this._date = getLocalDate(year, month, day, this._date.getHours(), this._date.getMinutes(), this._date.getSeconds(), this._date.getMilliseconds());
                                this.setViewDate(this._date);
                                this.fillDate();
                                this.set();
                                this.notifyChange()
        ...
        doAction: function(e) {
            e.stopPropagation();
            e.preventDefault();
            if (!this._date) this._date = getUTCDate(1970, 1, 0, 0, 0, 0, 0);
        ...
        formatDate: function(date) {
            ...
            return formatDate(convertLocalDateToUTCDate(d), this.format);
        },
        parseDate: function(str) {
            return parseDate(str, this.format);
        },
